...
public class Person implements Comparable<Person>, SillyActions {
    ...
    // Constructor to create a Person with the given info
    public Person(String firstName, String lastName, int yearBorn) {
        this.firstName = firstName != null ? firstName : default_first_name;
        this.lastName = lastName != null ? lastName : default_last_name;
        this.yearBorn = yearBorn > 0 ? yearBorn : default_year_born;
    }
